    ...
    return (
        <div className="flex items-center justify-between flex-wrap gap-5 mb-[34px]">
            ...
            <div className="flex items-center gap-4">
                <label className="flex items-center gap-2.5 bg-bone-2 border border-ink/15 py-2.5 px-4 min-w-[280px] rounded-sm">
                ...
                <button
                    ...
                    className="w-[38px] h-[38px] border border-ink/15 flex items-center justify-center relative transition-colors duration-200 hover:border-ink cursor-pointer"
                >
