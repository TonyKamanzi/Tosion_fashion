...
function OrderDetail({ order, onClose }: { order: Order; onClose: () => void }) {
    return (
        <div className="border border-ink/14 bg-white p-6 mb-6">
            ...
            <div className="flex items-center gap-2 mb-5">
                <span className={`inline-block px-2.5 py-0.5 rounded-full font-mono text-[10px] tracking-wider uppercase ${STATUS_STYLES[order.status] || ""}`}>
                    {order.status}
                </span>
            </div>
    ...
    if (loading) {
        return (
            <div className="mt-20 bg-bone min-h-[calc(100vh-80px)] flex items-center justify-center">
                <p className="font-mono text-[12px] text-sage">Loading...</p>
            </div>
        );
    }
        ...
        <div className="mt-20 bg-bone min-h-[calc(100vh-80px)]">
            ...
            <div className="px-[5vw] pb-[100px] grid grid-cols-[1fr_2fr] gap-14 max-[900px]:grid-cols-1 max-[900px]:gap-8">
                ...
                <div>
                    ...
                    {ordersLoading ? (
                        <p className="font-mono text-[12px] text-sage">Loading orders...</p>
                    ) : orders.length === 0 ? (
